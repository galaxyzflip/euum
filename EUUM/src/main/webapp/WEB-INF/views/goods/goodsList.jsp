	...
	<div class="container">
		...
		<div class="subContent">
			...
			<div id="cate_banner" class="clear">
				<a href="/goods/goodsDetail?goods_num=${goodsNum}"> <%-- 		<img src="${pageContext.request.contextPath}/resources/assets/img/image/zz1.jpeg/${goodsImage1}" alt="" style='width: 260px; height: 220px'> --%>
				</a> <a href="/goods/goodsDetail?goods_num=${goodsNum}"> <img
					src="${pageContext.request.contextPath}/resources/assets/img/image/zz2.jpeg/${goodsImage2}"
					alt="" style='width: 260px; height: 220px'>
				</a> <a href="/goods/goodsDetail?goods_num=${goodsNum}"> <img
					src="${pageContext.request.contextPath}/resources/assets/img/image/zz3.jpeg/${goodsImage3}"
					alt="" style='width: 260px; height: 220px'>
				</a> <a href="/goods/goodsDetail?goods_num=${goodsNum}"> <img
					src="${pageContext.request.contextPath}/resources/assets/img/image/zz3.jpeg/${goodsImage3}"
					alt="" style='width: 260px; height: 220px'>
					...
					<div style="float: left; font-size: 14.5px;">
						<div id="search_Box">
							<form method="get" action="/goods/goodsSearch">
								...
								</select> <span> <input type="text" name="searchKeyword"
									id="searchKeyword"
						...
						<div class="goodsSort">
							<form method="post" action="/goods/goodsSort" name="sortType">
								<select id="sortType" name="sort-order" class="sort-order"
									onchange="sortOrder()">
									<option value="1">최신순</option>
									<option value="2">인기순</option>
								</select> <select id="sort-commers" name="sort-commers"
									class="sort-commers" onchange="sortCommers()">
						...
						<div class="lgBtn"
							onclick="location.href='index.php?channel=today'">최근 본 작가</div>
					</div>
					<!-- </ul> -->
					<!-- <ul class="right"> -->
					<div style="float: right; font-size: 14.5px;">
						<div class="sBtn1" style="height: 42px; line-height: 42px;"
							onclick="writer_chk('1')">작품 등록 / 수정</div>
						<!-- </ul> -->
					</div>
				</div>
			</div>
