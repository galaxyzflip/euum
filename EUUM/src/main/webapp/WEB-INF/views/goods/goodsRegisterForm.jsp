		...
		<form action="/goods/goodsRegisterPro" method="post" id="goodsForm" enctype="multipart/form-data">
			...
			<hr style="border:solid 1px #FF6600;"><br/><br/>
				<table>
					...
					<tr>
						<th>제목</th>
						<td>
							<input type="text" name="goodsName" id="input_goodsName" class="input_text_l" placeholder="특수문자, 이모티콘 등으로 제목을 강조하는 경우 예고 없이 삭제됩니다">
			...
			<div class="div_register">
				<table>
					...
					<tr>
						<th>제출파일 유형</th>
						<td>
							<input type="text" name="goodsFormat" id="input_goodsFormat" class="input_text_s" placeholder="예) png, jpg, ai">
					...
					<tr>
						<th>기본 사이즈</th>
						<td>
							<input type="text" name="goodsSize" id="input_goodsSize" class="input_text_s" placeholder="예) 1280x720, A4">
					...
					<tr>
						<th>작업 해상도</th>
						<td>
							<input type="text" name="goodsResolution" id="input_goodsResolution" class="input_text_s">
							dpi
					...
					<tr>
						<th>수정 횟수</th>
						<td>
							<input type="text" name="goodsModifyCount" id="input_goodsModifyCount" class="input_text_ss" placeholder="">
							회
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="goodsPeriod" id="input_goodsPeriod" class="input_text_ss">
							일
			...
			<div class="div_register">
				<table class="opTable">
					...
					<tbody class="opBody_1" id="opBody_1">
			...
			<div style="position: fixed; bottom: 100px; right: 0; z-index: 10">
				<div>
					<button type="button" id="registerTempBtn">임시저장</button>
				</div>
				<div>
