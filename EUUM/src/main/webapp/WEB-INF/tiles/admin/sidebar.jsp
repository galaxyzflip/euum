...
<ul
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		aria-expanded="true" aria-controls="collapseUtilities"> <i
			class="fas fa-fw fa-wrench"></i> <span>알림사항</span>
	</a>
		<div id="collapseUtilities" class="collapse"
			aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<h6 class="collapse-header">관리 정보:</h6>
				<a class="collapse-item" href="utilities-color.html">알림</a> <a
					class="collapse-item" href="utilities-border.html">문의사항</a> <a
					class="collapse-item" href="utilities-border.html">신고</a>
			</div>
		</div></li>

	<!-- Nav Item - Tables -->
	<li class="nav-item"><a class="nav-link collapsed" href="#"	data-toggle="collapse" data-target="#collapseBoard"
		aria-expanded="true" aria-controls="collapseBoard"> <i
			class="fas fa-fw fa-table"></i> <span>관리자 게시판</span>
	</a>
		<div id="collapseBoard" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item" href="#">의뢰게시판</a> 
				<a class="collapse-item" href="#">상품문의</a> 
				<a class="collapse-item" href="#">상품리뷰</a>
	...
	<li class="nav-item"><a class="nav-link" href="charts.html"> <i
			class="fas fa-fw fa-chart-area"></i> <span>주문 차트</span>
	</a></li>
