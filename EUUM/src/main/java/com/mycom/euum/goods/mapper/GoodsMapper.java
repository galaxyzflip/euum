...
//	private SqlSessionTemplate sqlSession;
	...
	public List<GoodsBean> selectMyGoodsList(@Param("memberNum")int memberNum, @Param("pageNum")int pageNum, @Param("amount")int amount) throws Exception;
	
	/** 선민: 나의 상품 리스트 가져오기 - 승인대기 상품 (List) */
	public List<GoodsBean> selectMyUnapprovedGoodsList(@Param("memberNum")int memberNum, @Param("pageNum")int pageNum, @Param("amount")int amount) throws Exception;
	
	/** 선민: 나의 상품 리스트 가져오기 - 임시저장 상품 (List) */
	public List<GoodsBean> selectMyTempGoodsList(@Param("memberNum")int memberNum, @Param("pageNum")int pageNum, @Param("amount")int amount) throws Exception;
	...
	public void updateGoodsImage(@Param("goodsBean")GoodsBean goodsBean, @Param("sequence")int sequence) throws Exception;
