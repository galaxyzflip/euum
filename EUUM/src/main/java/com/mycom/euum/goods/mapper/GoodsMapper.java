...
//	private SqlSessionTemplate sqlSession;
	...
	/** 선민: (페이징) 상품 총개수 가져오기 */
	public int getGoodsTotalCount(@Param("memberNum") int memberNum, @Param("goodsStatus") String goodsStatus)
			throws Exception;
	...
	public void updateTempGoods(GoodsBean goodsBean);
	...
	public List<GoodsOptionBean> selectGoodsOptionContent(@Param("goodsNum") String goodsNum,
			@Param("goodsOptNameNum") String goodsOptNameNum) throws Exception;

	/** 선민: 관리자 상품조회 리스트 */
	public List<GoodsBean> selectAdminGoodsList() throws Exception;

	/** 선민: 관리자 상품 상태변경 */
	public void updateAdminGoodsStatus(@Param("goodsNum") String goodsNum, @Param("goodsStatus") String goodsStatus)
			throws Exception;
